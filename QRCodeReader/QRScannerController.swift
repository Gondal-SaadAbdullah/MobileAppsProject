...
class QRScannerController: UIViewController, AVCaptureMetadataOutputObjectsDelegate, CLLocationManagerDelegate {
    ...
    func captureOutput(_ captureOutput: AVCaptureOutput!, didOutputMetadataObjects metadataObjects: [Any]!, from connection: AVCaptureConnection!) {
        ...
        if metadataObj.type == AVMetadataObjectTypeQRCode {
            ...
            if metadataObj.stringValue != nil {
                ...
                messageLabel.text = "height :: \(qrCodeFrameView!.layer.bounds.height), width :: \(qrCodeFrameView!.layer.bounds.width)"
            }
        }
    }
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        messageLabel.text = "locations = \(locValue.latitude) \(locValue.longitude)"
    }
